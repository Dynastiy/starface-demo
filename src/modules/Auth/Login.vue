<template>
  <div class="flex flex-col justify-between">
    ...
    <div class="">
      <h3 class="lg:text-2xl text-center dark:text-white md:text-2xl text-xl font-bold mb-0">Welcome back</h3>
      <span class="text-[15px] block dark:text-white font-regular text-gray2 text-center"
      ...
      <div class="text-center mt-12">
        ...
        <div class="mt-3">
          <span class="flex justify-center gap-1 text-[13px]">
            <span class="font-medium text-gray2 dark:text-white">Don't have an account?</span>
